...
enum Color {
    case green, red, purple, lightBlue, blue, orange, primary, secondary, lightGray, lightGray2, lightGreen
    
    var color: UIColor {
        switch self {
        case .primary: return getPrimaryColor()
        case .secondary: return UIColor(red: 0.24, green: 0.24, blue: 0.26, alpha: 1)
        ...
        case .lightBlue: return UIColor(red: 0.35, green: 0.78, blue: 0.98, alpha: 1)
